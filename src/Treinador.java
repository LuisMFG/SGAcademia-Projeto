...
public class Treinador extends Pessoa {
    ...
    // Construtor que inicializa os atributos da classe, incluindo o atributo específico para treinadores
    public Treinador(String nome, String dataNascimento, String endereco, String cep,
        ...
        // Chamada ao construtor da classe base (Pessoa) para inicializar os atributos comuns
    ...
    // Sobrescrita do método toString para fornecer uma representação textual do treinador
    @Override
